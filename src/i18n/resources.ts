  ...
  en: {
    translation: {
      ...
      discovery: {
        ...
        explanationTitle: "Recommendation explanation",
        reason: {
  ...
  es: {
    translation: {
      ...
      discovery: {
        ...
        dismiss: "Descartar",
        reset: "Restablecer",
        showMore: "Mostrar más como esto",
        showLess: "Mostrar menos como esto",
        notInterested: "No me interesa",
        hideAuthor: "Ocultar este autor",
        whyThis: "¿Por qué veo esto?",
        explanationTitle: "Explicación de la recomendación",
        reason: {
