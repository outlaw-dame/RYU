...
export const collections = {
  ...
  reviews: { schema: { title: 'reviews schema', version: reviewVersion, type: 'object', primaryKey: 'id', additionalProperties: false, indexes: ['editionId', 'accountId', 'published'], properties: { id, title: text, content: longText, editionId: id, accountId: id, reviewerAccountId: id, reviewerAttributionSource, rating: { type: 'number', minimum: 0, maximum: 5 }, published: timestamp, importedAt: timestamp, updatedAt: timestamp }, required: ['id', 'content', 'editionId', 'accountId', 'published', 'importedAt', 'updatedAt'] }, migrationStrategies: { 1: passThrough, 2: passThrough } },
